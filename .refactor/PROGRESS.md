...
- 进度：**5 / 7** 张卡完成
- 阻塞：0 张
- 进程内统计：cycle=1 workerRuns=2（启动于 2026-09-16T08:51:38.998Z）
- 更新时间：2026-09-16T08:53:27.998Z
...
| M0-05 | 仓库卫生：config.yaml 入 .gitignore（保留本地不再跟踪）、补 config.template.yaml、取消忽略 tests/ | running | 0 | — | 编排器重启前遗留的 running，已自动重置 |
