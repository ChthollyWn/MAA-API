...
- 进度：**2 / 7** 张卡完成
- 阻塞：0 张
- 进程内统计：cycle=1 workerRuns=0（启动于 2026-09-16T08:52:05.942Z）
- 更新时间：2026-09-16T08:52:16.613Z

| 卡 | 标题 | 状态 | 尝试 | commit | 阻塞原因 |
|---|---|---|---|---|---|
| M0-00 | 流水线自检：验证 worker 能落盘并提交 | done | 0 | 59825d8 |  |
| M0-01 | 升级依赖到 pydantic v2（FastAPI/uvicorn 同步升级 + SQLModel/Alembic/aiosqlite/httpx）并建好本仓 .venv | done | 0 | f47e3a5 |  |
| M0-02 | 按 02 §6 建立 maa_api 新目录骨架（core/domain/db/services/agent/api/util 空模块占位） | running | 0 | — |  |
