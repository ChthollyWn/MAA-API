...
- 进度：**7 / 21** 张卡完成
- 阻塞：0 张
- 进程内统计：cycle=0 workerRuns=0（启动于 2026-09-16T09:08:12.506Z）
- 更新时间：2026-09-16T09:08:12.510Z
...
| M1-01 | 方案前置实测：AsyncCallInfo 回调载荷结构 + 本地内核构建来源与导出符号能力 | running | 0 | — |  |
| M1-02 | 方案前置实测：子进程隔离最小验证（spawn 子进程→真实内核加载→跨进程回调→杀进程→观察重启） | pending | 0 | — |  |
