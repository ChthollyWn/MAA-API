...
- 进度：**0 / 7** 张卡完成
- 阻塞：0 张
- 进程内统计：cycle=0 workerRuns=0（启动于 2026-09-16T08:51:38.998Z）
- 更新时间：2026-09-16T08:51:39.000Z

| 卡 | 标题 | 状态 | 尝试 | commit | 阻塞原因 |
|---|---|---|---|---|---|
| M0-00 | 流水线自检：验证 worker 能落盘并提交 | running | 0 | — |  |
| M0-01 | 升级依赖到 pydantic v2（FastAPI/uvicorn 同步升级 + SQLModel/Alembic/aiosqlite/httpx）并建好本仓 .venv | running | 0 | — |  |
...
| M0-05 | 仓库卫生：config.yaml 入 .gitignore（保留本地不再跟踪）、补 config.template.yaml、取消忽略 tests/ | pending | 0 | — |  |
