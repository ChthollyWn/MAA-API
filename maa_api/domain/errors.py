...
class ErrorCode(StrEnum):
    ...
    # API 调试台收藏 id 不存在
    API_SNIPPET_NOT_FOUND = "API_SNIPPET_NOT_FOUND"

    # API 调试台收藏名称重复
    API_SNIPPET_NAME_CONFLICT = "API_SNIPPET_NAME_CONFLICT"
...
ERROR_HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.API_SNIPPET_NOT_FOUND: 404,
    ErrorCode.API_SNIPPET_NAME_CONFLICT: 409,
